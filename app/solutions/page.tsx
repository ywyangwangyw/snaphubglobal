  ...
  return (
    <>
      <Hero
        ...
        subtitle="Whether you're an OEM, IT reseller, or hardware startup — SnapHub connects you with the right products and support. Everything starts with an inquiry."
